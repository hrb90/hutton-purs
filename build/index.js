...
(function(exports) {
  ...
  var maybeParens = function (parser) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parser)(Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("("))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(")"))(parser));
  };
  var decimal = (function () {
      ...
      var toInt = function (arr) {
          ...
          throw new Error("Failed pattern match at Parser line 16, column 21 - line 19, column 9: " + [ v.constructor.name ]);
      };
  ...
  var parseHutton = maybeParens(Text_Parsing_Parser_Expr.buildExprParser(Data_Identity.monadIdentity)([ [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("+"))(Data_Hutton.Add.create), Text_Parsing_Parser_Expr.AssocRight.value), new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_Token.space(Data_Identity.monadIdentity))(Data_Function["const"](Control_Category.id(Control_Category.categoryFn))), Text_Parsing_Parser_Expr.AssocRight.value) ] ])(decimal));
