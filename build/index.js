...
(function(exports) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 20, column 1 - line 20, column 20: " + [ v.constructor.name ]);
  };
  var decimal = (function () {
      var charToInt = function (x) {
          ...
          return __unused()((function () {
              ...
              throw new Error("Failed pattern match at Main line 29, column 39 - line 41, column 1: " + [ x.constructor.name ]);
          })());
      };
      var toInt = function (arr) {
          ...
          throw new Error("Failed pattern match at Main line 26, column 21 - line 29, column 9: " + [ v.constructor.name ]);
      };
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($15) {
          return Lit.create(toInt(Data_Array.reverse($15)));
  ...
  var parseHutton = Text_Parsing_Parser_Expr.buildExprParser(Data_Identity.monadIdentity)([ [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("+"))(Add.create), Text_Parsing_Parser_Expr.AssocRight.value) ] ])(decimal);
  var main = (function () {
      var parseAndEval = Data_Functor.map(Data_Functor.functorFn)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Text_Parsing_Parser.showParseError)))(Data_Function.flip(Text_Parsing_Parser.runParser)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))($$eval)(parseHutton)));
